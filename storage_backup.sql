...
CREATE POLICY "Users can delete own files" ON "storage"."objects" FOR DELETE USING ((("bucket_id" = 'user-files'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text")));



CREATE POLICY "Users can delete videos from their own folder" ON "storage"."objects" FOR DELETE USING ((("bucket_id" = 'user-files'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text") AND (("storage"."foldername"("name"))[2] = 'videos'::"text")));



CREATE POLICY "Users can read own files" ON "storage"."objects" FOR SELECT USING ((("bucket_id" = 'user-files'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text")));



CREATE POLICY "Users can read videos from their own folder" ON "storage"."objects" FOR SELECT USING ((("bucket_id" = 'user-files'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text") AND (("storage"."foldername"("name"))[2] = 'videos'::"text")));



CREATE POLICY "Users can update own files" ON "storage"."objects" FOR UPDATE USING ((("bucket_id" = 'user-files'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text"))) WITH CHECK ((("bucket_id" = 'user-files'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text")));



CREATE POLICY "Users can upload own files" ON "storage"."objects" FOR INSERT WITH CHECK ((("bucket_id" = 'user-files'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text")));



CREATE POLICY "Users can upload videos to their own folder" ON "storage"."objects" FOR INSERT WITH CHECK ((("bucket_id" = 'user-files'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text") AND (("storage"."foldername"("name"))[2] = 'videos'::"text")));
