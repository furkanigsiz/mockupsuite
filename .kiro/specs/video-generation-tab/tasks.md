...
- [x] 2. Create Veo3Service for video generation





  - [x] 2.1 Implement generateVideo function
  ...
  - [x] 2.2 Add error handling and timeout logic
  ...
  - [x] 2.3 Write unit tests for Veo3Service
...
- [x] 3. Update StorageService for video handling





  - [x] 3.1 Implement uploadVideo function
  ...
  - [x] 3.2 Implement getVideoUrl function
  ...
  - [x] 3.3 Implement deleteVideo function

    - Delete video from Supabase Storage
    - Handle deletion errors
    - _Requirements: 3.3_
  
  - [x] 3.4 Write unit tests for video storage functions
...
- [x] 4. Update SubscriptionService for video quota management




  - [x] 4.1 Implement canGenerateVideo function
  ...
  - [x] 4.2 Implement decrementVideoQuota function
...
- [x] 5. Create database migration for videos table
...
- [x] 6. Update ModeSwitcher component to include video mode
...
- [x] 7. Create VideoGeneratorControls component





  - [x] 7.1 Create component structure and props interface
  ...
  - [x] 7.2 Implement image uploader section
  ...
  - [x] 7.3 Implement video prompt input
  ...
  - [x] 7.4 Implement duration selector
  ...
  - [x] 7.5 Implement aspect ratio selector
  ...
  - [x] 7.6 Implement generate button
  ...
  - [x] 7.7 Write unit tests for VideoGeneratorControls
...
- [x] 8. Update App.tsx to support video mode





  - [x] 8.1 Add video-specific state variables
  ...
  - [x] 8.2 Implement handleVideoGenerate function
  ...
  - [x] 8.3 Update GeneratorControls rendering logic
  ...
  - [x] 8.4 Update results display logic
...
- [x] 9. Update GeneratorControls component to handle video mode
...
- [x] 10. Add video-related translations to locale files
  ...
  - [x] 10.1 Add translations to en.ts
  ...
  - [x] 10.2 Add translations to tr.ts


    - Translate all video-related strings to Turkish
    - _Requirements: 1.1, 1.2, 2.2, 6.1_
  
  - [x] 10.3 Add translations to es.ts


    - Translate all video-related strings to Spanish
    - _Requirements: 1.1, 1.2, 2.2, 6.1_

- [x] 11. Update QueueManagerService to support video requests
...
- [x] 12. Update DatabaseService for video operations





  - [x] 12.1 Implement saveVideo function
  ...
  - [x] 12.2 Implement getVideos function
  ...
  - [x] 12.3 Implement deleteVideo function
  ...
  - [x] 12.4 Write unit tests for video database operations
...
- [x] 13. Update QuotaWidget to display video quota
...
- [x] 14. Add video support to offline queue system
...
- [x] 15. Update BrandKit integration for videos




  - [x] 15.1 Apply brand colors to video prompts


    - Inject brand color information into video generation prompts
    - _Requirements: 5.1_
  
  - [x] 15.2 Support watermark application to videos
  ...
  - [x] 15.3 Associate videos with project brand settings
...
- [x] 16. Implement video save and download functionality





  - [x] 16.1 Add save video handler
  ...
  - [x] 16.2 Implement video download
  ...
  - [x] 16.3 Add remove video handler
...
- [x] 17. Add environment variables and configuration





  - Add VITE_VEO3_API_KEY to .env.local (same google ai api don't need to change)
...
- [x] 18. Configure Supabase Storage for videos
...
- [x] 19. Update error handling for video generation
