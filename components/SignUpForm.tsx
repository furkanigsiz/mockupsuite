    ...
    <div className="w-full max-w-md mx-auto p-6">
      <div className="bg-white dark:bg-[#1c2527] rounded-xl border border-gray-200 dark:border-[#3b4f54] p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {isLoading ? t('auth_signing_up') : t('auth_sign_up')}
          </button>
        </form>
        ...
        <div className="mt-6">
          <div className="relative">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-gray-300 dark:border-[#3b4f54]"></div>
            </div>
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white dark:bg-[#1c2527] text-gray-500 dark:text-gray-400">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <button
              ...
              disabled={isLoading}
              className="flex items-center justify-center px-4 py-2 border border-gray-300 dark:border-[#3b4f54] rounded-lg bg-white dark:bg-[#111718] text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-[#1c2527] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
